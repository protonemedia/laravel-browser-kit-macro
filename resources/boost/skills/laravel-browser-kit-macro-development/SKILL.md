...
description: Application integration guidance for protonemedia/laravel-browser-kit-macro.
license: MIT
metadata:
  author: ProtoneMedia
---
...
## Overview
Use `protonemedia/laravel-browser-kit-macro.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-browser-kit-macro.` classes, facades, config, or documented features.
